...
| 57 | ⛔ **폐기** | ~~LaTeX 3파일 동기화~~ | **2026-08-15 사용자 결정 — 앞으로 하지 않는다.** LaTeX 3파일(`hibari_tda.tex` / `ko.tex` / `report.tex`)은 md 와 동기화하지 않는다. 새 수치는 md 계열(`academic_paper_full.md` / 환대_포트폴리오)에만 반영한다 |
