"""
§5.2 Bach Fugue 독립 재실험 (post-bugfix)

저장:
  docs/step3_data/classical_contrast_bach_postbugfix_results.json
"""
...
TRACK_NAME = "bach_fugue"
MIDI_FILE = "bach-toccata-and-fugue-in-d-minor-piano-solo.mid"
