...
def task25(data):
    print("\n" + "=" * 72)
    print("Task 25 — §4.1 거리 함수 비교 (gap_min=3, N=20)")
    print("=" * 72)

    results = {"n_repeats": 20, "min_onset_gap": MIN_ONSET_GAP}
    ...
    out_path = os.path.join(STEP3_DIR, "step3_results_gap3.json")
...
def task26(data):
    print("\n" + "=" * 72)
    print("Task 26 — §4.1b Duration Weight (DFT + gap_min=3, N=10)")
    print("=" * 72)
    ...
    out_path = os.path.join(STEP3_DIR, "dw_gridsearch_dft_results.json")
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def read_best_dw():
    path = os.path.join(STEP3_DIR, "dw_gridsearch_dft_results.json")
...
def task27(data):
    print("\n" + "=" * 72)
    print("Task 27 — §4.1a Octave Weight (DFT + gap_min=3, N=10)")
    print("=" * 72)
    ...
    out_path = os.path.join(STEP3_DIR, "ow_gridsearch_dft_results.json")
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def read_best_ow():
    path = os.path.join(STEP3_DIR, "ow_gridsearch_dft_results.json")
    with open(path, "r", encoding="utf-8") as f:
...
def task28a(data):
    print("\n" + "=" * 72)
    print("Task 28a — §4.1c 감쇄 Lag (gap_min=3, N=20)")
    print("=" * 72)
    ...
    out_path = os.path.join(STEP3_DIR, "decayed_lag_gap3_results.json")
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def task28(data):
    print("\n" + "=" * 72)
    print("Task 28 — §4.2 Continuous OM (DFT + gap_min=3, N=20)")
    print("=" * 72)
    ...
    out_path = os.path.join(STEP3_DIR, "step3_continuous_dft_gap3_results.json")
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def task29(data):
    print("\n" + "=" * 72)
    print("Task 29 — §4.3 DL 모델 비교 (DFT binary OM + gap_min=3, N=5)")
    print("=" * 72)
    ...
    out_path = os.path.join(STEP3_DIR, "dl_comparison_dft_gap3_results.json")
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def task30(data):
    print("\n" + "=" * 72)
    print("Task 30 — §4.3a FC-bin vs FC-cont (DFT + gap_min=3, N=5)")
    print("=" * 72)
    ...
    out_path = os.path.join(STEP3_DIR, "fc_cont_dft_gap3_results.json")
    with open(out_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def main():
    parser = argparse.ArgumentParser(description="DFT + gap_min=3 Task 25~30 runner")
