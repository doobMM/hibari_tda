"""
§6.6.1 Tonnetz major_block32 post-bugfix 재실험 (세션 A)
...
출력:
- docs/step3_data/post_bugfix_tonnetz_major_block32_results.json
"""
...
OUT_PATH = os.path.join(STEP3, "post_bugfix_tonnetz_major_block32_results.json")
...
def main() -> None:
    ...
    print("=" * 84)
    print("§6.6.1 Tonnetz major_block32 post-bugfix 실험")
    print("=" * 84)
    print(
    ...
    payload = {
        "experiment": "section_6_6_1_tonnetz_major_block32_post_bugfix",
