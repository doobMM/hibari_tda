...
| **E. Control Tower** | 전체 추적, 우선순위, 커밋 | memory/, AGENTS.md, git log | 소스코드·논문 내부 |
...
**읽는 것:** memory/, AGENTS.md, git log/status, 피드백 txt, step3_data/ JSON (수치만)
...
3. AGENTS.md "다음 우선 작업" 표에 후속 작업 반영
...
| # | 세션 | 작업 | 의존성 | 비고 |
|---|------|------|--------|------|
| 7 | **D** | §4.1b 신설 — 감쇄 lag 실험 결과표 ✓ | 완료 | §2.9 참조 수정 포함 (2026-04-15) |
