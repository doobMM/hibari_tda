...
def get_hibari_notes(adn_1_whole_c, adn_2_whole_c, notes_dict) :
    ...
    inst1_notes = specify_chord_list(adn_1_whole_c, notes_dict)
    inst2_notes = specify_chord_list(adn_2_whole_c, notes_dict)
...
def verify_scaled_cycles_by_scores(hibari_lists : list[list], cycle_labeled : dict, for_scores : dict, 
                                    notes_label : dict, flexible_pitches : dict,
                                    output_dir : str = "./test_xml") :
    ...
    for cycle_idx in cycle_labeled.keys():
        ...
        musicxml_file = notes_to_score_xml(cycle_scaled, 
                                        file_name=f"{cycle_idx}. {for_score[0]} on scale {for_score[2]}",
